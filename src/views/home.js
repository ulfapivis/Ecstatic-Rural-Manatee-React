...
const Home = (props) => {
  return (
    <div className="home-container">
      <Helmet>
        <title>Ecstatic Rural Manatee</title>
        <meta property="og:title" content="Ecstatic Rural Manatee" />
      </Helmet>
      ...
      <Hero1
        action1={
          <Fragment>
            <span className="home-text20 thq-body-small">Main action</span>
          </Fragment>
        }
        action2={
          <Fragment>
            <span className="home-text21 thq-body-small">Secondary action</span>
          </Fragment>
        }
        content1={
          <Fragment>
